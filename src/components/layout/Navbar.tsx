...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white py-3 px-0.5 rounded-xl grid grid-cols-5 fixed bottom-2 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] left-1/2 transform -translate-x-1/2 w-[95%]">
